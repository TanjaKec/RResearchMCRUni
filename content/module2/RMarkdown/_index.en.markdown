...
The `120 years of Olympic history: athletes and results` data set was uploaded to [Kaggle](https://www.kaggle.com) by [Randi H Griffin, PhD](http://www.randigriffin.com/2018/05/27/olympic-history-1-web-scraping.html) who has subsequently written a series of blog posts analysing different aspects of the data.
...
-	Find the number of medals per team for the Rio games
...
We already have the R code that will provide the results for these questions. 👆😅
